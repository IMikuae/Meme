...
let handler = async (m, { conn, args, text, usedPrefix: _p, command, isROwner }) => {    
    //Manage panel
    const domain = "https://fallxzx.floiyrine.biz.id" // Domain
const apikey = "ptla_zBGINHa7fZ9qmK6GlCixy1uJaDvb3ujlJ28ejqF2UuL" // Apikey
const c_apikey = "ptlc_aTLkzjlISLKDJZ3682o3nBkHzUlmcdOWZrvSJoVREz7" // c Apikey
...
handler.help = handler.command = ["addusr", "addsrv", "delsrv", "listsrv", "detsrv", "reinstall", "updatesrv", "startsrv", "stopsrv", "restartsrv"];
